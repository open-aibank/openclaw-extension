...
version: 1.0.0
author: open-aibank
metadata: {"clawdbot":{"emoji":"🖼️","env":["TRON_PRIVATE_KEY"],"triggers":["demo x402-payment", "show me x402 demo"]}}
...
1.  **Request Resource**: When triggered, follow the instructions provided by the `x402_payment_tron` skill to fetch the protected resource. **Use Tron Nile by default**:
